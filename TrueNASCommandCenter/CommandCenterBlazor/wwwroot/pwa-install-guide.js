    ...
    function getGuidance(platform, isSecureContext) {
        if (!isSecureContext) {
            return {
                ...
                title: "Open the HTTPS Command Center address",
                message: "Android blocks app installation from plain HTTP addresses such as truenas.local and private IPs.",
                steps: [
                    "Open this Command Center through its trusted HTTPS reverse-proxy address in Chrome or Samsung Internet.",
                    "Choose Install app again from the Command Center menu.",
        ...
        switch (platform) {
            ...
            case Platform.AndroidFirefox:
                return {
                    ...
                    title: "Add the Command Center to your phone",
            ...
            case Platform.Ios:
                return {
                    ...
                    title: "Add the Command Center to your Home Screen",
