...
builder.Services.AddSingleton<ITrueNasPerformanceClient>(services => services.GetRequiredService<TrueNasJsonRpcClient>());
builder.Services.AddSingleton<ITrueNasDataProtectionClient>(services => services.GetRequiredService<TrueNasJsonRpcClient>());
builder.Services.AddSingleton<ITrueNasDriveHealthClient>(services => services.GetRequiredService<TrueNasJsonRpcClient>());
...
builder.Services.AddSingleton<TrueNasPerformanceService>();
builder.Services.AddSingleton<ITrueNasPerformanceService>(services => services.GetRequiredService<TrueNasPerformanceService>());
builder.Services.AddSingleton<IDataProtectionCenterService, DataProtectionCenterService>();
builder.Services.AddSingleton<IDrivePoolHealthService, DrivePoolHealthService>();
...
builder.Services.AddSingleton<ISystemPerformanceMonitor>(services => services.GetRequiredService<SystemPerformanceMonitorService>());
...
builder.Services.AddHostedService(services => services.GetRequiredService<SystemPerformanceMonitorService>());
